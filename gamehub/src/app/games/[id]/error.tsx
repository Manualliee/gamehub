    ...
    <div className="relative w-full min-h-[60vh] flex flex-col items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md bg-card/80 backdrop-blur-md border border-border/30 rounded-2xl p-8 shadow-2xl text-center">
        ...
        <p className="text-muted-foreground mb-8 text-sm leading-relaxed">
          We encountered a critical error while processing this game&#39;s data. Please try again or return to GameHub&#39;s dashboard.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/dashboard"
            className="px-6 py-2.5 rounded-xl border border-accent bg-background/50 hover:bg-accent/50 hover:text-accent-foreground transition-all"
          >
            Return to Dashboard
          </Link>
        </div>
